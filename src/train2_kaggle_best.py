...
from omegaconf import DictConfig, OmegaConf, open_dict, open_dict
...
def make_optimizer(cfg: DictConfig, model: nn.Module) -> torch.optim.Optimizer:
    ...
    use_diff_lr = model_name == "video_swin" and bool(cfg.training.get("differential_lr", True))
...
def main(cfg: DictConfig) -> None:
    # Robust fix: if Hydra put the experiment config under cfg.experiment,
    # merge it into the global config before using cfg.model/cfg.training/cfg.dataset.
